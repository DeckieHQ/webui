export default {
  ...
  "notifications": {
    ...
    "event-unsubmit": "a annulé sa demande à",
    "event-join": "a rejoint la partie",
  ...
  "profile": {
    ...
    "short-description": {
      ...
      "placeholder": "Etudiant le jour, guerrier elfe la nuit !"
    },
    "description": {
      "label": "Description",
      "placeholder": "Qui je suis, ce que j'aime."
    },
    "avatar": {
      "new": "Ajouter photo",
      "edit": "Modifier photo"
  ...
  "event-comment": "a commenté la partie",
  "timeslot-join": "a rejoint le créneau horaire",
  "timeslot-leave": "a quitté le créneau horaire",
  "timeslot-confirm": "a validé la date pour la partie",
  "timeslot-cancel": "a annulé le créneau horaire",
  "comment-comment": "a commenté le commentaire",
  ...
  "email-sent": "Invitation(s) envoyée(s)",
  ...
  errors: {
    ...
    confirmation: "Ne correspond pas au {{attribute}}",
    accepted: "doit être accepté",
    empty: "ne peut pas être vide",
    blank: "ne peut pas être vide",
    present: "doit être vide",
    tooLong: "est trop long (maximum {{count}} caractères)",
    tooShort: "est trop court (minimum {{count}} caractères)",
    ...
    greaterThanOrEqualTo: "doit être plus grand ou égal à {{count}}",
